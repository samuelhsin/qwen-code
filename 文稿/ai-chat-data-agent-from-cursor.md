...
更新：2026-08-30 15:11 UTC（固定路径覆盖写入，不另存日期副本）
...
距离 8 月 31 日硬窗口只剩约 9 小时：GPT-5.4 / 5.4 mini 退出 Codex 的 ChatGPT 登录通道（API Key 会话不受影响）；Kimi k2.5 与 moonshot-v1 日落，迁到 K3。Claude Code 自 5 月起上浮 50% 的周限额延至 9 月 13 日，官方称 9 月 14 日起永久上调 25%，相对当前额度净减约 17%。
...
国内窗口已从数博会闭幕切到成果盘点。新华社称本届数博会今日正式闭幕，展出 1100 余项新产品新技术，发布 87 项创新成果，并办 31 场展产融合活动；现场亮点包括科杰 Keen Agentic OS。中国互联网协会与中国信通院《数据智能体研究报告（2026）》征求意见与案例征集截至 9 月 5 日。来伊份基于火山引擎 HiAgent 与豆包做成 500 多个智能体，200 多个已进巡检、补货、审批。海尔智家把“智小能”做成企业 Agent OS，腾讯云以 ClawPro 提供沙箱与工程化。阿里云 DataWorks Data Agent 底层换成 Qwen Code Daemon，并接入 Qwen3.8-max。办公入口仍是「豆包工作」、腾讯 WorkBuddy、阿里千问办公。帆软 FineBI NEXT、Aloudata、腾讯云 TCDataAgent 都把语义层写成 NL2MQL2SQL。IDC 预期 2026 年半数中国 500 强部署分析类 Agent，近四成卡在治理与口径。

## 三、判断

1. 未来 9 小时先盯 Codex ChatGPT 登录通道与 Kimi 日落；Claude Code 限额回落改看 9 月 13–14 日，不要与今夜窗口混为一谈。
2. 模型供给切断与价卡促销已同时写入采购条款：须写多模型隔离、熔断，以及促销到期后的成本回摆。
3. 智能体安全已从原则变成事故统计、联名施压、伦理审查与支付授权：评测隔离、写回权限、可验证授权、欧盟信息披露要同步上。
4. Data Agent 胜负手是写回路径、语义层、行业 MCP 与可审计控制面，而不是聊天壳。数博会 87 项成果与 9 月 5 日行业报告意见截止，是接下来两周的国内对照点。
