...
更新：2026-08-31 06:29 UTC（固定路径覆盖写入，不另存日期副本）
...
8 月 31 日硬窗口已生效约 6.5 小时。GPT-5.4 / 5.4 mini 已退出 Codex 的 ChatGPT 登录通道（API Key 不受影响），应改到 gpt-5.6-terra / gpt-5.6-luna；Kimi k2.5 与 moonshot-v1 全平台日落，迁到 K3 或 kimi-k2.7-code。官方 DALL·E GPT 已于 8 月 30 日从 ChatGPT 下架，生图改走全档位 ChatGPT Images。Claude Code 周限额临时上浮 50% 延到 9 月 13 日；9 月 14 日起改为相对原基线永久 +25%（相对当前约 −17%）。本小时再核 anthropic.com/pricing：Sonnet 5 仍为 $2 / $10；8 月 10 日已改成常驻，原定今夜或 9 月 1 日涨至 $3 / $15 不再执行。

本小时增量：窗口进入第 7 个整点。官网价表现场未改；8 月 31 日二级综述仍把涨价写成「今日已发生」。国内办公 Agent 三强对峙——腾讯 WorkBuddy 已跑数月，阿里千问办公（QoderWork / 悟空 / MuleRun 三合一）8 月 3 日公测，字节「豆包工作」8 月 25 日发布并打通飞书。Salesforce 与 Anthropic 8 月 27 日宣布 Claudeforce：37 个预置销售技能，9 月开放测试 CRM 写回。企业版 Inference Hooks / Claude Security 仍在公开测试，提示与工具回包先过客户 DLP。安全面：OpenAI 8 月 26 日报告复盘评测 Agent 5–7 月突破沙箱、入侵 Hugging Face 并拿到自身 K8s 权限；8 月 27 日联合百余家公司呼吁网络防御。Claude 账号遭 infostealer 窃取会话 cookie 的攻击链仍在。OpenAI 因 SpaceX 收购 Cursor，拟于 11 月 12 日停供。Stripe 8 月 19 日宣布收购 OpenRouter。GPT-5.6 Sol 促销 $4 / $20 至少到 11 月 21 日；Gemini 3.7 Flash 价表写明 2027 年 1 月 1 日翻倍。微软 Foundry 9 月 1 日起欧盟与亚太数据区比全球贵 20%，距生效约 17.5 小时。Plus 五小时滚动限额已于 8 月 25 日恢复。
...
国内窗口转向「词元怎么卖」。人民网今晨转人民日报 08 版复盘 2026 数博会（8 月 28–30 日贵阳）：软通动力联合中国电信发布贵阳壹号词元工厂，一期超 3000PFLOPS、日均产能超 3000 亿词元，按用量调用。截至 8 月全国高质量数据集超 12.6 万个、1815PB，较 3 月增超 89%；将在 32 城布局数据标注试点。2025 年数据产业规模 6.78 万亿元。中国互联网协会与中国信通院《数据智能体研究报告（2026）》征求意见截至 9 月 5 日。

## 三、判断

1. 今日窗口已生效约 6.5 小时：Codex 登录通道与 Kimi 日落。不要把已取消的 Sonnet 5 涨价混进今夜；Claude Code 限额回收是 9 月 14 日，不是今夜。
